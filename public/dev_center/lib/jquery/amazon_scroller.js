...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var nav_w = p&&p.scroller_nav_width?p.scroller_nav_width:876;
        j += "px";
        k += "px";
        m += "px";
        n += "px";
        ...
        function begin(){
            ...
            var u=dom.find("ul:first").outerWidth();
            var v=dom.find("ul:first").outerHeight();
            ...
            dom.find(".amazon_scroller_nav").width(nav_w+60);
        ...
        function s_s_nav(a,d){
            ...
            a.children("li").css('background-image','url("'+d+'/aw-arrow.png")');
