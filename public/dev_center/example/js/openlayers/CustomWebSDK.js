...
(function (f) {
    ...
    var define, module, exports;return function () {
        function r(e, n, t) {
            ...
            OpenLayers.Kinetic.prototype.move = function (_super) {
                return function () {
                    ...
                    var callback = function callback(x, y, end) {
                        if (end) {
                            x = Math.round(x);
                            y = Math.round(y);
                        }
            ...
            var versionStr = 'jssdk_bate@ openlayers 2.3.4';
        ...
        }, { "./ext/OlExt": 327, "./filter/Filter": 329, "./filter/FilterLayer": 330, "./layer/GServiceGroup": 332, "./layer/datasource/DataSource": 333, "./layer/datasource/LocalDataSource": 334, "./layer/datasource/URLDataSource": 335, "./layer/label/GWVTAnno": 336, "./layer/label/feature/Feature": 347, "./layer/vector/GXYZ": 348, "babel-polyfill": 1 }], 332: [function (require, module, exports) {
            /**
            ...
            var GServiceGroup = function () {
                ...
                /*后端底图*/
                GServiceGroup.prototype.addBaseLayer = function addBaseLayer(url) {
                    var tileSize = new OpenLayers.Size(this.tileSize, this.tileSize);
                    this.layer = new OpenLayers.Layer.GXYZ(this.layerId, this.url + "&x=${x}&y=${y}&l=${z}&tileType=" + this.layerType, { sphericalMercator: false, isBaseLayer: true, tileSize: tileSize });
                    this.map.addLayers([this.layer]);
                };

                GServiceGroup.prototype.addFrontBaseLayer = function addFrontBaseLayer(url) {};

                /*后端注记绘制*/
                GServiceGroup.prototype.AddImgLabel = function AddImgLabel() {
                    var tileSize = new OpenLayers.Size(this.tileSize, this.tileSize);
                    this.label = new OpenLayers.Layer.GXYZ(this.layerId + "_Label", this.url + "&x=${x}&y=${y}&l=${z}&tileType=" + this.labelType, { sphericalMercator: false, isBaseLayer: false, tileSize: tileSize });
                ...
                GServiceGroup.prototype.addAvoidLabel = function addAvoidLabel(url) {
                    this.label = new OpenLayers.Layer.GWVTAnno(this.url + '&x=${x}&y=${y}&l=${z}&tileType=' + this.labelType, { tileSize: this.tileSize, hitDetection: true, keepBuffer: 0, updateWhenZooming: false });
                    this.map.addLayers([this.label]);
                };
        ...
        }, { "../../utils/UUID": 351 }], 334: [function (require, module, exports) {
            ...
            var LocalDataSource = function (_DataSource) {
                ...
                function LocalDataSource() {
                    ...
                    //数据源类型
                    var _this = _possibleConstructorReturn(this, _DataSource.call(this));

                    _this.type = 'LocalDataSource';
                    //本地要素集合
                    _this.features = [];
        ...
        }, { "./../../utils/es6-promise": 352, "./DataSource": 333 }], 335: [function (require, module, exports) {
            /**
             * Created by kongjian on 2017/6/30.
             */
            var DataSource = require('./DataSource');
            ...
            var URLDataSource = function (_DataSource2) {
                ...
                function URLDataSource() {
                    ...
                    var _this2 = _possibleConstructorReturn(this, _DataSource2.call(this));

                    _this2.urlArray = [];
                    //数据源类型
                    _this2.type = 'URLDataSource';
                    //注记数据的请求url
                    _this2.url = null;
                    //样式文件的请求接口url
                    _this2.styleUrl = null;
                    //样式文件Id
                    _this2.styleId = 'style';
                    //过滤条件
                    _this2.filter = null;
                    //纹理
                    _this2.textures = {};
                    ...
                    _this2.control = null;
                    //过滤的id
                    _this2.controlId = null;
                    // 不带过滤条件的url
                    _this2.sourceUrl = null;
                    //域名
                    _this2.host = '';
                    //服务名
                    _this2.servername = '';
                ...
                URLDataSource.prototype.loadStyle = function loadStyle(styleType) {
                    ...
                    if (this.styleId == '_default__') {
                        var styleStr = 'var layers = drawer.getAllLayer(); layers.setStyle(function(level , get){' + ' return {"type":"_default__","show":true,"pointFillStyle":"#ff0000","radius":5,"lineFillStyle":"#00ff00","lineWidth":3 }' + '})';
                        this.styleFun = new Function("drawer", "level", styleStr);
                        return [def0];
                    }

                    //请求样式文件
                    getJSON({ url: this.host + '/mapserver/styleInfo/' + this.servername + '/' + this.styleId + '/' + styleType + '/style.js?' + Math.random() + '&' + queryParam, dataType: 'text' }).then(function (result) {
        ...
        }, { "../../ext/Version": 328, "./../../utils/es6-promise": 352, "./DataSource": 333 }], 336: [function (require, module, exports) {
            /**
             * Created by kongjian on 2017/6/26.
             */
            ...
            var GWVTAnno = OpenLayers.Class(OpenLayers.Layer, {
                 ...
                 * grid -  当前范围对应的瓦片层行列号
                 */
                getGrid: function getGrid(bounds) {
                    var maxExtent = this.map.getMaxExtent();
                ...
                setMap: function setMap(map) {
                    ...
                    this.canvasLayer.root.style.position = 'absolute';
        ...
        }, { "./draw/CanvasLayer": 345 }], 337: [function (require, module, exports) {
            ...
            var GAnnoAvoid = function () {
                ...
                GAnnoAvoid.prototype.defaultAvoid = function defaultAvoid(features, hasImportant, ableWeight) {
        ...
        }, { "./GGridIndex": 342, "./GLabelBox": 343 }], 339: [function (require, module, exports) {
            ...
            var GCutLine = function () {
                ...
                GCutLine.createLineTextFeatrue = function createLineTextFeatrue(feature, index) {
                    ...
                    if (AvoidUtil.isNotNull(feature.label)) {
                        ...
                        if (textPoints.length > 1) {
                            ...
                            var p2 = textPoints[textPoints.length - 1][0];
                            ...
                            if (style.isImportant && !style.showRoadCode) {
                                textFeature = this.cloneFeature(feature);
                                textFeature.attributeId = textFeature.attributeId + '_text';
                ...
                GCutLine.delayTextPoint = function delayTextPoint(line, textPoints, label, gap) {
                    var fristPoint = null;
                ...
                GCutLine.getLineDistance = function getLineDistance(line) {
                    ...
                    var dis = 0;
                    for (var _i23 = 0; _i23 < line.length / 2 - 1; _i23++) {
                        var p1 = [line[2 * _i23], line[2 * _i23 + 1]];
                        var p2 = [line[2 * (_i23 + 1)], line[2 * (_i23 + 1) + 1]];
        ...
        }, { "./../../../utils/gistools/GisTools": 354, "./AvoidUtil": 337, "./GDistance": 340 }], 340: [function (require, module, exports) {
            /**
            ...
            var GDrawGeomerty = function () {
                ...
                GDrawGeomerty.draw = function draw(ctx, features, ratio, checkDraw, isChangeFont, hitCtx, hitDetection) {
                    ...
                    for (var _i24 = 0; _i24 < features.length; _i24++) {
                        var feature = features[_i24];
                        //画点注记
                        if (feature.type == 1) {
                 ...
                 * features - 设置过样式，转换过为屏幕坐标，避让过的注记数据
                 */
                GDrawGeomerty.drawDefaultStyle = function drawDefaultStyle(ctx, features, ratio, checkDraw, isChangeFont, hitCtx, hitDetection) {
                    var drewMap = null;
                    if (checkDraw) {
                        drewMap = new Map();
                    }
                    ...
                    if (style.pointHashBackground == true) {
                        ...
                        for (var _j8 = 0; _j8 < numRows; _j8++) {
                            if (style.pointHashOutline == true) {
                                ...
                                ctx.strokeText(labelRows[_j8], pt[0] * ratio, (pt[1] + lineHeight * _j8) * ratio);
                                ctx.restore();
                            }
                            ...
                            ctx.fillText(labelRows[_j8], pt[0] * ratio, (pt[1] + lineHeight * _j8) * ratio);
                            ctx.restore();
                        }
                ...
                GDrawGeomerty.drawLineText = function drawLineText(ctx, feature, ratio, drewMap, isChangeFont, hitCtx, hitDetection) {
                    ...
                    if (style.lineHashBackground == true || textPoints.length == 1) {
                        ...
                        //开始绘制线注记
                        for (var _j9 = 0; _j9 < label.length; _j9++) {
                            var pa = textPoints[_j9];
                            var angle = pa[1];
                            var point = pa[0];
                            var labelChar = label.charAt(_j9);
                ...
                GDrawGeomerty.drawArrowhead = function drawArrowhead(ctx, x, y, radians, ratio, size) {
                    ctx.beginPath();
                ...
                GDrawGeomerty.drawPointDefaultStyle = function drawPointDefaultStyle(ctx, feature, ratio, drewMap, isChangeFont, hitCtx, hitDetection) {
                    var style = feature.style;
                ...
                GDrawGeomerty.drawLineDefaultStyle = function drawLineDefaultStyle(ctx, feature, ratio, drewMap, isChangeFont, hitCtx, hitDetection) {
                    var style = feature.style;
                    ...
                    for (var _i28 = 1; _i28 < datas.length; _i28++) {
                        ctx.lineTo(datas[_i28][0][0], datas[_i28][0][1]);
                    }
                    ctx.stroke();
                    ctx.restore();
                };
        ...
        }, { "../../../utils/gistools/BoxSet": 353, "../../../utils/gistools/GisTools": 354, "./AvoidUtil": 337, "./Util": 344 }], 342: [function (require, module, exports) {
            ...
            var GLabelBox = function () {
                ...
                GLabelBox.prototype.setPointBox = function setPointBox(feature, datas, ctx) {
                    ...
                    if (labelIsNotNull) {
                        ...
                        for (var _i29 = 0; _i29 < tmpLabels.length; _i29++) {
                            var oneRowLabelWidth = Util.measureText(tmpLabels[_i29], ctx.font, ctx);
                    ...
                    if (feature.style.texture) {
                        //如果有文字
                        if (feature.label) {
                            var rightBox = [pt[0] - graphicWidth * 0.5, pt[1] - style.pointBackgroundGap - currPara.maxFontheight * 0.5, pt[0] + graphicWidth * 0.5 + style.graphicDistance + currPara.fontwidth + style.pointBackgroundGap * 2, pt[1] + currPara.maxFontheight * 0.5 + style.pointBackgroundGap];
                            ...
                            var bottomBox = [pt[0] - currPara.fontwidth * 0.5 - style.pointBackgroundGap, pt[1] - graphicHeight * 0.5, pt[0] + currPara.fontwidth * 0.5 + style.pointBackgroundGap, pt[1] + graphicHeight * 0.5 + style.graphicDistance + style.pointBackgroundGap * 2 + currPara.maxFontheight];

                            var topBox = [bottomBox[0], pt[1] - style.graphicDistance - style.pointBackgroundGap * 2 - currPara.maxFontheight - graphicHeight * 0.5, bottomBox[2], pt[1] + graphicHeight * 0.5];
                            ...
                            //不包括点图标,用于文字绘制的起点坐标
                            var rPoint = [pt[0] + graphicWidth * 0.5 + style.graphicDistance + style.pointBackgroundGap, pt[1] - currPara.fontheight * 0.5 + style.pointHeight * 0.5];
                            var lPoint = [pt[0] - graphicWidth * 0.5 - style.graphicDistance - style.pointBackgroundGap - currPara.fontwidth, pt[1] - currPara.fontheight * 0.5 + style.pointHeight * 0.5];
                            var bPoint = [pt[0] - currPara.fontwidth * 0.5, pt[1] + style.graphicDistance + style.pointBackgroundGap + style.pointHeight * 0.5 + graphicHeight * 0.5];
                            var tPoint = [bPoint[0], pt[1] - style.graphicDistance - style.pointBackgroundGap - currPara.fontheight + style.pointHeight * 0.5 - graphicHeight * 0.5];
                            fourPoints = [rPoint, lPoint, bPoint, tPoint];
                        } else {
                            //只有图标，没有文字
                            var middleBox = [pt[0] - graphicWidth * 0.5, pt[1] - graphicHeight * 0.5, pt[0] + graphicWidth * 0.5, pt[1] + graphicHeight * 0.5];
                        ...
                        var _middleBox = [pt[0] - currPara.fontwidth * 0.5 - style.pointBackgroundGap, pt[1] - style.pointBackgroundGap - currPara.maxFontheight * 0.5, pt[0] + currPara.fontwidth * 0.5 + style.pointBackgroundGap, pt[1] + style.pointBackgroundGap + currPara.maxFontheight * 0.5];
                        _middleBox = this.boxScale(_middleBox, style.pointBoxDisance);
                        boxs = [_middleBox];

                        var mPoint = [pt[0] - currPara.fontwidth * 0.5, pt[1] - currPara.fontheight * 0.5 + style.pointHeight * 0.5];
                        fourPoints = [mPoint];
                        feature.directions = { 0: 1 };
                    }
                ...
                GLabelBox.prototype.filterFeature = function filterFeature(features) {
                    var returnFeatures = [];
                    //剔除需避让的要素
                    for (var _i30 = 0; _i30 < features.length; _i30++) {
                        if (!features[_i30].hidden) {
                            returnFeatures.push(features[_i30]);
                        }
                    }
                    return returnFeatures;
                };
                ...
                GLabelBox.prototype.isMessy = function isMessy(textPoints, style, label) {
                    ...
                    for (var _i31 = 0; _i31 < label.length; _i31++) {
                        var currPoint = textPoints[_i31][0];
                        var currAngle = textPoints[_i31][1];
                ...
                GLabelBox.prototype.getLineBoxs = function getLineBoxs(label, textPoints, style) {
                    ...
                    //自相交避让的boxs
                    var owmCrashBoxs = [];
                    for (var _i32 = 0; _i32 < label.length; _i32++) {
                        var pt = textPoints[_i32][0];
                        //解决旋转后的注记和不旋转的注记样式不一致的问题
                        if (textPoints[_i32][1] == 0) {
                            textPoints[_i32][1] = 0.5;
                        }
                    ...
                    if (!style.isImportant) {
                        for (var _j10 = 0; _j10 < owmCrashBoxs.length - 1; _j10++) {
                            var box1 = owmCrashBoxs[_j10];
                            for (var k = _j10 + 1; k < owmCrashBoxs.length; k++) {
                ...
                GLabelBox.prototype.textToSameBearing = function textToSameBearing(angle, textPoints) {
                    ...
                    for (var _i33 = 0; _i33 < textPoints.length; _i33++) {
                        var p = textPoints[_i33][1];
                        var offsetAngle = angle - p;
                        if (offsetAngle > 45) {
                            textPoints[_i33][1] = p + 90;
                        }
                        if (offsetAngle < -45) {
                            textPoints[_i33][1] = p - 90;
                        }
        ...
        }, { "./AvoidUtil": 337, "./Util": 344 }], 344: [function (require, module, exports) {
            var Util = function () {
                function Util() {
            ...
            var AvoidUtil = require('../avoid/AvoidUtil');
            ...
            var CanvasLayer = function () {
                ...
                CanvasLayer.prototype.getDataSourceById = function getDataSourceById(dataSoucceId) {
                    for (var _i36 = 0; _i36 < this.dataSource.length; _i36++) {
                        if (this.dataSource[_i36].id == dataSoucceId) {
                            return this.dataSource[_i36];
                        }
                    }
                };
                ...
                CanvasLayer.prototype.getLocalLabelDatas = function getLocalLabelDatas() {
                    ...
                    for (var _i37 = 0; _i37 < this.dataSource.length; _i37++) {
                        var ds = this.dataSource[_i37];
                        if (ds.type == 'LocalDataSource') {
                            for (var _j11 = 0; _j11 < ds.features.length; _j11++) {
                                var feature = ds.features[_j11];
                                ...
                                if (feature.inBounds(this.extent)) {
                                    ...
                                    if (feature.type == 1) {
                                        ...
                                        var datas = feature.transformData(this.extent, this.res);
                ...
                CanvasLayer.prototype.getRequestTileUrls = function getRequestTileUrls(grid) {
                    ...
                    for (var _i38 = 0; _i38 < this.dataSource.length; _i38++) {
                        var dataSource = this.dataSource[_i38];
                        //url数据源
                        if (dataSource.type == 'URLDataSource') {
                            var url = dataSource.url;
                            for (var _j12 = 0; _j12 < grid.length; _j12++) {
                                var item = grid[_j12];
                 ...
                 * results - 请求成功的结果
                 */
                CanvasLayer.prototype.sendSuccess = function sendSuccess(results, defaultStyleResult) {
                 ...
                 * results - 请求成功的结果
                 */
                CanvasLayer.prototype.drawDefaultStyleLabel = function drawDefaultStyleLabel(results) {
                    ...
                    for (var _i39 = 0; _i39 < results.length; _i39++) {
                        var item = results[_i39];
                        this.cache.push(item.url, item);
                    }

                    //保证当前屏幕内需要拾取的要素
                    if (this.hitDetection) {
                        for (var _i40 = 0; _i40 < labelFeatures.length; _i40++) {
                            var feature = labelFeatures[_i40];
                ...
                CanvasLayer.prototype.drawLabel = function drawLabel(results) {
                    //合并上次在当前视口范围内的注记要素(不包括本地要素)
                    var mergeFeatures = this.mergeLabelData(results, this.hitCacheUrls, false);
                    var labelFeatures = mergeFeatures.labelFeatures;

                    for (var _i41 = 0; _i41 < results.length; _i41++) {
                        var item = results[_i41];
                        this.cache.push(item.url, item);
                    }
                    ...
                    //保证当前屏幕内需要拾取的要素
                    if (this.hitDetection) {
                        for (var _i42 = 0; _i42 < avoidlabelDatas.length; _i42++) {
                            var feature = avoidlabelDatas[_i42];
                            this.features[feature.id] = feature;
                        }
                    }
                    //绘制注记要素
                ...
                CanvasLayer.prototype.drawAvoidLine = function drawAvoidLine(avoidLineFeatures) {
                    ...
                    for (var _i43 = 0; _i43 < avoidLineFeatures.length; _i43++) {
                        var avoidLineFeature = avoidLineFeatures[_i43];
                ...
                CanvasLayer.prototype.parseFeature = function parseFeature(tileData) {
                    ...
                    if (count > 0 && dataSource && dataSource.styleFun) {
                        ...
                        for (var _j13 = 0; _j13 < itemDatas.length; _j13++) {
                            var itemData = itemDatas[_j13];
                ...
                CanvasLayer.prototype.setGlobalStyle = function setGlobalStyle(globalStyle) {
                ...
                CanvasLayer.prototype.parseAvoidLine = function parseAvoidLine(layerAvoids, xyz) {
                    ...
                    for (var weight in layerAvoids) {
                        ...
                        for (var _i44 = 0; _i44 < lines.length; _i44++) {
                            var feature = {};
                            feature.weight = weight;
                            feature.sourceDatas = lines[_i44];
                            feature.datas = this.transformAvoidLine(lines[_i44], xyz);
                            feature.xyz = xyz;
                ...
                CanvasLayer.prototype.transformAvoidLine = function transformAvoidLine(line, xyz) {
                    ...
                    for (var _i45 = 0; _i45 < line.length / 2; _i45++) {
                        var px = line[2 * _i45];
                        var py = line[2 * _i45 + 1];
                 ...
                 * @param components
                 */
                CanvasLayer.prototype.processLineString = function processLineString(lines, itemData, components) {
                    if (Array.isArray(components[0])) {
                        var len = components.length;
                        for (var _i46 = 0; _i46 < len; _i46++) {
                            var component = components[_i46];
                            this.processLineString(lines, itemData, component);
                        }
                    } else {
                        var ls = this.parseMultiLine(itemData, components);
                        for (var _i47 = 0; _i47 < ls.length; _i47++) {
                            lines.push(ls[_i47]);
                        }
                    }
                };
                ...
                CanvasLayer.prototype.parseMultiLine = function parseMultiLine(itemData, datas) {
                    ...
                    var feature = { type: itemData.type, sourceData: datas, label: label, weight: weight, roadCodeLabel: roadCodeLabel, attributes: itemData.fieldValueMap,
                ...
                CanvasLayer.prototype.cutLineFeature = function cutLineFeature(feature, isLocal) {
                    ...
                    for (var _i48 = 0; _i48 < features.length; _i48++) {
                        var f = features[_i48];
                        //转换为屏幕坐标
                        if (isLocal) {
                ...
                CanvasLayer.prototype.transformData = function transformData(points, xyz) {
                    ...
                    for (var _i49 = 0; _i49 < points.length; _i49++) {
                        var point = points[_i49][0];
                        var gx = point[0] + xyz.col * this.tileSize;
                        var gy = point[1] + xyz.row * this.tileSize;
                        var p = [gx - x, gy - y];
                        rPoint.push([p, points[_i49][1]]);
                    }
                    return rPoint;
                };
                 ...
                 * Returns:
                 */
                CanvasLayer.prototype.lineToSourceAngleData = function lineToSourceAngleData(line) {
                    var sourceAngleData = [];
                    for (var _i50 = 0; _i50 < line.length; _i50++) {
                        var x = line[_i50];
                        var y = line[_i50 + 1];
                 ...
                 */
                CanvasLayer.prototype.mergeLabelData = function mergeLabelData(results, hitCacheUrls, isDefaultStyle) {
                    var labelFeatures = [];
                    var avoidLineFeatures = [];
                    for (var _j14 = 0; _j14 < results.length; _j14++) {
                        var result = results[_j14];
                    ...
                    for (var _i51 = 0; _i51 < urls.length; _i51++) {
                        var cacheLabelFeatures = this.cache.getItem(urls[_i51]).labelFeatures;
                        for (var _j15 = 0; _j15 < cacheLabelFeatures.length; _j15++) {
                            var labelFeature = cacheLabelFeatures[_j15];
                            //重新计算当前屏幕坐标
                        ...
                        var cacheAvoidLineFeatures = this.cache.getItem(urls[_i51]).avoidLineFeatures;
                        for (var _j16 = 0; _j16 < cacheAvoidLineFeatures.length; _j16++) {
                            var avoidLineFeature = cacheAvoidLineFeatures[_j16];
                            //重新计算当前屏幕坐标
        ...
        }, { "../../../utils/Cache": 350, "../avoid/AvoidUtil": 337, "../avoid/GDrawGeomerty": 341, "./../../../utils/es6-promise": 352, "./../avoid/GAnnoAvoid": 338, "./../avoid/GCutLine": 339, "./LabelDrawer": 346 }], 346: [function (require, module, exports) {
            /**
            ...
            var LabelDrawer = function () {
                ...
                LabelDrawer.prototype.getAllLayer = function getAllLayer() {
                    this.labelDatas = [];
                ...
                LabelDrawer.prototype.setItemLayer = function setItemLayer(layername) {
                    var data = this.layerDataMap[layername];
                    if (data == null || data.features == null) {
                        return;
                    }

                    for (var _j17 = 0; _j17 < data.features.length; _j17++) {
                        var labelData = data.features[_j17];
                        labelData.layerName = layername;
                        labelData.xyz = data.xyz;
                        labelData.type = data.type;
                        if (!labelData.fieldValueMap) {
                ...
                LabelDrawer.prototype.getGroupLayer = function getGroupLayer(layername, value) {
                    ...
                    for (var _j18 = 0; _j18 < length; _j18++) {
                        var dataArr = data.features[valueArr[_j18]];
                        if (dataArr == null) {
                            continue;
                        }
                ...
                LabelDrawer.prototype.setStyle = function setStyle(fn) {
                    ...
                    var _loop = function _loop(_i52) {
                        var labelData = _this3.labelDatas[_i52];
                        var get = function get(key) {
                            return labelData.fieldValueMap[key];
                        };
                        var style = fn.call({}, _this3.level, get);
                        if (style && style.show == true) {
                            labelData.style = style;
                            labelData.fieldValueMap['avoidWeight'] = style.avoidWeight;
                            _this3.features.push(labelData);
                        }
                    };

                    for (var _i52 = 0; _i52 < this.labelDatas.length; _i52++) {
                        _loop(_i52);
                    }
                };

                LabelDrawer.prototype.setGlobalStyle = function setGlobalStyle(fn) {
                    this.globalStyle = fn.call({});
                };

                LabelDrawer.prototype.getFieldValueMap = function getFieldValueMap(data, labelData) {
                    var fieldValueMap = {};
                    for (var _i53 = 0; _i53 < data.fieldsConfig.length; _i53++) {
                        var fieldName = data.fieldsConfig[_i53]['name'];
                        var index = data.fieldsConfig[_i53]['index'];
                        var id = data.fieldsConfig[_i53]['id'];
                        if (id == true) {
                            //图层名和数据的主键构成唯一id
            ...
            var Feature = function () {
                ...
                Feature.prototype.getMaxExtent = function getMaxExtent() {
                    ...
                    for (var _i54 = 2; _i54 < this.latlngData.length; _i54++) {
                        var tempX = this.latlngData[_i54];
                        var tempY = this.latlngData[_i54 + 1];
                        if (tempX > maxX) // 判断最大值
                            maxX = tempX;
                        if (tempX < minX) // 判断最小值
                            minX = tempX;
                ...
                Feature.prototype.transformData = function transformData(srceenBounds, res) {
                    ...
                    for (var _i55 = 0; _i55 < this.latlngData.length; _i55++) {
                        var sx = this.latlngData[_i55];
                        var sy = this.latlngData[_i55 + 1];
            ...
            var GXYZ = OpenLayers.Class(OpenLayers.Layer.XYZ, {
                ...
                //瓦片大小
                tilesize: 256,
                initialize: function initialize(name, url, options) {
                    if (window.devicePixelRatio > 1.5) {
                        this.ratio = 2;
                    }
                 ...
                 * callback - 拾取成功的回调函数
                 */
                getFeatureByLonlat: function getFeatureByLonlat(lonlat, callback) {
                ...
                highlightFeatures: function highlightFeatures(layerFeatures, style) {
                    ...
                    //如果没有过滤任何要素
                    if (!this.highlightLayer || filter.layers.length == 0) {
                        return;
                    }
                    ...
                    this.highlightLayer.setOpacity(style.opacity);
                },
                ...
                highlightByFilter: function highlightByFilter(filter) {
                    ...
                    //设置高亮过滤条件
                    this.highlightLayer.setFilter(filter);
                    this.highlightLayer.setOpacity(1);
                },

                /**
                 * 克隆对象
                 */
                cloneOptions: function cloneOptions(myObj) {
                    if ((typeof myObj === "undefined" ? "undefined" : _typeof(myObj)) != 'object' || myObj == null) return myObj;
            ...
            module.exports = GXYZ;
        }, { "../../ext/Version": 328, "./draw/GXYZUtil": 349 }], 349: [function (require, module, exports) {
            /**
             * Created by kongjian on 2017/6/26.
             */
            ...
            var GXYZUtil = function () {
                ...
                GXYZUtil.prototype.parseUrl = function parseUrl(url) {
                    ...
                    var params = this.queryParam.split('&');
                    for (var _i56 = 0; _i56 < params.length; _i56++) {
                        var param = params[_i56];
                        var keyValue = param.split('=');
                        if (keyValue[0] == 'styleId') {
                            this.styleId = keyValue[1];
                            return;
                ...
                GXYZUtil.prototype.pickupFeatures = function pickupFeatures(row, col, level, x, y, control, controlId, callback) {
                    var url = this.host + '/mapserver/pickup/' + this.servername + '/getData?' + this.queryParam + '&x=' + col + '&y=' + row + '&l=' + level + '&pixelX=' + x + '&pixelY=' + y + '&tilesize=' + this.tileSize + '&clientVersion=' + Version;
                    if (control) {
        ...
        }, { "../../../ext/Version": 328, "./../../../filter/Filter": 329, "./../../../filter/FilterLayer": 330, "./../../../utils/es6-promise": 352 }], 350: [function (require, module, exports) {
            /**
        ...
        }, { "./jx": 355 }], 353: [function (require, module, exports) {
            ...
            var GisTools = function () {
                ...
                GisTools.polyWith = function polyWith(polyOut, polyIn) {
                    ...
                    var cY = void 0;
                    var dX = void 0;
                    for (var _i57 = 0; _i57 < lengthOut; _i57++) {
                        ...
                        for (var _j20 = 0; _j20 < lengthIn; _j20++) {
            ...
            (function (global) {
                !function (e) {
                    if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module) module.exports = e();else if ("function" == typeof define && define.amd) define([], e);else {
                        var f;"undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.jx = e();
                    }
                }(function () {
